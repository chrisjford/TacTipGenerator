...
def pointsCalculator(n, x1, r):
    ...
    points = []
    theta = math.asin(x1/r) # ZX angle
    points.append((0,0,r)) # Plot centre pin point
    ...
    while i <= n:
        ...
        while k <= m/6:
            ...
            x0 = r*math.sin(i*theta)
            z = r*math.cos(i*theta)
...
def run(context):
    ...
    try:
        ...
        revInput = revolves.createInput(prof, axisLine, adsk.fusion.FeatureOperations.NewBodyFeatureOperation)     # Adds a revolve input item to revolve features
        ...
        thickness = adsk.core.ValueInput.createByReal(t)
